      ...
      <div className={styles.animated__layers}>
        ...
        >
          <h1 className={styles.title}>
            <span>
              <animated.span style={textStyles}>LyL</animated.span>
            </span>
            <span>
              <animated.span style={textStyles}>分布式故障检测系统</animated.span>
            </span>
          </h1>
        </animated.div>
      </div>
...
export default TestReactSpring;
